...
class DeveloperCommands(commands.Cog):
    ...
    async def dev_guild_register(
            ...
            guild_id: disnake.Guild = commands.Param(name="guild", description="Discord ID сервера"),
    ...
    @dev_guild.sub_command(name="info", description="[DEV] Посмотреть информацию о сервере")
    ...
    @dev_guild.sub_command(name="add_role", description="[DEV] Подключить роль к серверу")
    ...
    @dev_guild.sub_command(name="remove_role", description="[DEV] Отключить роль от сервера")
    ...
    @dev_guild.sub_command(name="notifies_enable", description="[DEV] Включить уведомления о выдаче и снятии ролей")
    ...
    @dev_guild.sub_command(name="notifies_disable", description="[DEV] Отключить уведомления о выдаче и снятии ролей")
    ...
    @dev_guild.sub_command(name="channel", description="[DEV] Изменить рабочий канал для сервера")
    ...
    @dev_guild.sub_command(name="add_log_role", description="[DEV] Подключить роль для логирования на сервере")
    ...
    @dev_guild.sub_command(name="remove_log_role", description="[DEV] Отключить роль от логирования на сервере")
    ...
    @dev_guild.sub_command(name="log_roles_channel",
    ...
    @dev_guild.sub_command(name="admin_grant", description="[DEV] Выдать серверу административные права")
    ...
    @dev_guild.sub_command(name="admin_revoke", description="[DEV] Забрать у сервера административные права")
